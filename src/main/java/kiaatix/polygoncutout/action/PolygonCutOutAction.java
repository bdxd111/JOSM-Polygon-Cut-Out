...
//	private void createMultiPolygon(DataSet data, MultiPolygon selectedMultiPolygon) {
//		// Get all suitable background polygons
//		List<MultiPolygon> backgroundPolygons = QueryUtils.getUnselectedMultiPolygons(data,
//				p -> p.get("building") == null						// Cannot be a building
//						&& p.get("man_made") == null				// Cannot be a man made object
//						&& !"residential".equals(p.get("landuse"))	// Cannot be a residential area
//						&& !"industrial".equals(p.get("landuse")));	// Cannot be an industrial area
//		for (MultiPolygon backgroundPolygon : backgroundPolygons) {
//			doCreateMultiPolygon(data, selectedMultiPolygon, backgroundPolygon);
//		}
//	}
	
//	private void doCreateMultiPolygon(DataSet data, MultiPolygon foreground, MultiPolygon background) {
//		BetterPolygonMerger m = new BetterPolygonMerger(data);
//		if (background.canBeInnerWay(foreground.getOuterWay())) {
//			MultiPolygon newBackground = new MultiPolygon(background);
//			newBackground.addInnerWay(foreground.getOuterWay());
//			m.addMultiPolygon(newBackground);
//
//			if (background.hasRelation()) {
...
//				
//				Iterator<Way> newWayIterator = newBackground.iterator();
